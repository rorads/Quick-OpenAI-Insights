...
TEXT_FILE_PATH = "data/final/output_teams.json"
ANALYTICS_COLUMNS = ['sentiment', 'urgency', 'descriptive_normative', 'questioning']


class TeamsCallDashboard:
    """
    Class to create a dashboard for the Teams Call Transcript project.
    """

    def __init__(self, file_path: str, rolling_window: int = 10):
        """
        Args:
    ...
    def load_youtube_video(self):
        ...
        with video:
            # write an embedded video player using an iframe with the timecode of the selected row
            st.write(

                f'<iframe src="https://paconsulting-my.sharepoint.com/personal/chris_pickup_paconsulting_com/_layouts/15/embed.aspx?UniqueId=72f5e830-bf65-499b-b993-08f6950e36d9&nav=%7B%22playbackOptions%22%3A%7B%22startTimeInSeconds%22%3A{selected_row["timestamp"]}%7D%7D&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create" width="853" height="480" frameborder="0" scrolling="no" allowfullscreen title="Artificial Intelligence in Immigration - Initial Views-20230425_140836-Meeting Recording.mp4"></iframe>',
...
if __name__ == "__main__":
    dashboard = TeamsCallDashboard(file_path=TEXT_FILE_PATH)
    dashboard.run()
